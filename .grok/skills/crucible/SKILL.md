...
The skill source of truth is the repo harness view (`.grok/skills`, `.kiro/skills`,
`.claude/skills`, `.agents/skills`), not a `$HOME` copy. Codex uses `.agents/skills`
(no second `.codex/skills` tree).
