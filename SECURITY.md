...
in judge's clothing, closure with no falsifier, and a check that reported success while its input was
missing. Those are the failures that actually happen.
